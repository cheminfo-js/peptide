...
describe('Checking digest sequence', function () {
    it('Normal sequence digest', function () {
        var result=PEP.digestSequence("HLysLysAlaAlaLysOH", {enzyme:'trypsin', minMissed:0, maxMissed: 0});
        result.should.eql(["HLysOH","HLysOH","HAlaAlaLysOH"]);
    });

    it('Normal sequence digest, minMissed:0, maxMissed:1', function () {
        var result=PEP.digestSequence("HLysLysAlaAlaLysOH", {enzyme:'trypsin', minMissed:0, maxMissed: 1});
    ...
    it('Normal sequence digest, minMissed:1, maxMissed:1', function () {
        var result=PEP.digestSequence("HLysLysAlaAlaLysOH", {enzyme:'trypsin', minMissed:1, maxMissed: 1});
